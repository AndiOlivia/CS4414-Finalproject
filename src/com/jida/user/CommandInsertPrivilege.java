...
public class CommandInsertPrivilege extends Command {
	static Logger logger=Logger.getLogger(CommandInsertPrivilege.class);
	private User user;
	private Privilege item;
	public CommandInsertPrivilege(User user,Privilege item){
		this.user=user;
		this.item=item;
	}
	@Override
	public void execute() throws Exception {
		...
		try{
			...
			logger.error("CommandInsertPrivilege:",e);
			throw e;
		}
