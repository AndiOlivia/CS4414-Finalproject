...
public class CommandInsertGroup extends Command {
	static Logger logger=Logger.getLogger(CommandInsertGroup.class);
//	private User user;
//	private User item;
	private Group group;
	public CommandInsertGroup(Group group){
//		this.user=user;
//		this.item=item;
		this.group=group;
	}
	...
	public void execute() throws Exception {
		...
		try{
			...
			logger.error("Insert group failed:",e);
//			comment=e.toString();
			throw e;
		}
