...
public class CommandDeletePrivilege extends Command {
	static Logger logger=Logger.getLogger(CommandDeletePrivilege.class);
	private User user;
	private Privilege item;
	public CommandDeletePrivilege(User user,Privilege item){
		this.user=user;
		this.item=item;
	}
	@Override
	public void execute() throws Exception {
		...
		try{
			...
			logger.error("CommandDeletePrivilege:",e);
		}
