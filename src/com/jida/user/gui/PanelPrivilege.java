...
* LEGALLY FOR ANY CORPORATE OR COMMERCIAL PURPOSE.
*/
public class PanelPrivilege extends javax.swing.JPanel implements ToolBarable {
	...
	public static String name="Privilege Management";
...
//			this.jButtonUpdate.setToolTipText("更改");
			...
			this.jButtonUpdate.setMinimumSize(new Dimension(80,30));
		}
		{
...
//			this.jButtonRefresh.setToolTipText("刷新");
			...
			this.jButtonRefresh.setMinimumSize(new Dimension(80,30));
		}
		{
			this.jToolBar.addSeparator();
		}
...
//			this.add(jTextFieldValue, new GridBagConstraints(7, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		...
		
		{
			...
			this.jButtonSearch.setPreferredSize(new Dimension(30,30));
		}
