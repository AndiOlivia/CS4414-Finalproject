...
//		this.setPreferredSize(new java.awt.Dimension(421, 129));
	...
	private static SimpleDateFormat getDefaultDateFormat() {
		return new SimpleDateFormat("yyyy年MM月dd日HH时mm分00秒") ;
	} 
	//覆盖父类的方法
...
//		int currentSecond=c.get(Calendar.SECOND);//**************
		...
		//**************
		minSpin = new JSpinner(new SpinnerNumberModel(currentMin,0,60,1));
		minSpin.setPreferredSize(new Dimension(35,20)) ;
		minSpin.setName("Min") ;
		minSpin.addChangeListener(this) ; 
		result.add(minSpin) ;
		
		JLabel minLabel=new JLabel("分");
		minLabel.setForeground(controlTextColor);
		result.add(minLabel);
		
//		secSpin = new JSpinner(new SpinnerNumberModel(currentSecond,0,23,1));
//		secSpin.setPreferredSize(new Dimension(35,20)) ;
//		secSpin.setName("Second") ;
//		secSpin.addChangeListener(this) ; 
//		result.add(secSpin) ;
//		
//		JLabel secLabel=new JLabel("秒");
//		secLabel.setForeground(controlTextColor);
//		result.add(secLabel);
	...
	private int getSelectedMin(){//***************88
		return((Integer)minSpin.getValue()).intValue();
	}
	private int getSelectedSec(){//****************8
